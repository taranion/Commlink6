...
public interface Shadowrun6Rules extends ShadowrunRules {
	...
	public static Rule CHARGEN_LIFEPATH_ADJUSTMENT_KARMA = new Rule(EffectOn.CHARGEN,"CHARGEN_LIFEPATH_ADJUSTMENT_KARMA", Rule.Type.INTEGER, RES, "50");
	public static Rule CHARGEN_LIFEPATH_MAX_MODULES = new Rule(EffectOn.CHARGEN,"CHARGEN_LIFEPATH_MAX_MODULES", Rule.Type.INTEGER, RES, "8");
	public static Rule CHARGEN_LIFEPATH_MAX_QUALITIES = new Rule(EffectOn.CHARGEN,"CHARGEN_LIFEPATH_MAX_QUALITIES", Rule.Type.INTEGER, RES, "6");
	public static Rule CHARGEN_LIFEPATH_NEGATIVE_KARMA_CAP = new Rule(EffectOn.CHARGEN,"CHARGEN_LIFEPATH_NEGATIVE_KARMA_CAP", Rule.Type.INTEGER, RES, "20");
	public static Rule CHARGEN_LIFEPATH_START_NUYEN = new Rule(EffectOn.CHARGEN,"CHARGEN_LIFEPATH_START_NUYEN", Rule.Type.INTEGER, RES, "25000");
	...
	public static Rule[] values() {
		Rule[] sr6 = new Rule[] {
				...
				CHARGEN_LIFEPATH_ADJUSTMENT_KARMA,
				CHARGEN_LIFEPATH_MAX_MODULES,
				CHARGEN_LIFEPATH_MAX_QUALITIES,
				CHARGEN_LIFEPATH_NEGATIVE_KARMA_CAP,
				CHARGEN_LIFEPATH_START_NUYEN,
