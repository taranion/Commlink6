 ...
 *
 */
public class SR6FreeSpellGenerator extends ControllerImpl<SR6Spell> implements SR6SpellController, ISpellGenerator<SR6Spell> {
	...
	//-------------------------------------------------------------------
	protected SR6FreeSpellGenerator(SR6CharacterController parent) {
		super(parent);
	}
