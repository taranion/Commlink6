...
//		inverted = new Image("/icons/update4j-icon-invert.png");
		System.err.println("JavaFXDelegate.init: class loader 1 = "+ClassLoader.getSystemClassLoader());
		System.err.println("JavaFXDelegate.init: class loader 2 = "+System.getProperty("java.class.path"));
